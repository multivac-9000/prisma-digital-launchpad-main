...
export const Route = createFileRoute("/nueva-landing")({
  head: () => ({
    meta: [
...
/* Landing para empresas consolidadas (negocios físicos con 10+ años de trayectoria
   que quieren duplicar sus ventas online). Orden pensado para conversión:
   alivio (hero) → confianza (resultados) → urgencia (dolor) → solución (servicios)
   → riesgo cero (garantía + qué recibes) → acción (agenda). */

...
// Formulario de newsletter (modo HTML de Brevo), aislado en su propio iframe srcdoc.
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="max-width:540px; margin:0 auto; text-align:center; background-color:rgba(0,1,57,1); border-width:1px; border-style:solid; border-color:#d713f9; border-radius:5px; direction:ltr">
      <form id="sib-form" method="POST" action="https://345b4d6b.sibforms.com/serve/MUIFAN_Ng8yAMpFy0s-a9kNPr0q_DvozZJp2n-wS7f2_qGo7lq86UoJngwF8dUYM48NJKyqu80nKOeekIcBA_4yHMOx4wXD96ga2bQjBVfCgGj3r3K2-d3LsDnA_knMKhAxuOTN8VK0kTxYqPBa_MZ3u3nsMx8Uv1Ih38RQJ7qMuHXYWKVt99-U8kMCaD96Eup6x69oTx0glTVPi" data-type="subscription">
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-family:Futura, sans-serif; font-size:32px; font-weight:700; text-align:left; color:#fcfeff; background-color:transparent;"><p>Newsletter Digital</p></div>
        </div>
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-family:Helvetica, sans-serif; font-size:16px; text-align:left; color:#ffffff; background-color:transparent;"><div class="sib-text-form-block"><p>Suscríbete a nuestra newsletter para recibir novedades sobre optimización y marketing digital.</p></div></div>
        </div>
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                ...
                <div class="entry__field"><input class="input " type="text" id="EMAIL" name="EMAIL" autocomplete="off" value="" placeholder="EMAIL" data-required="true" required /></div>
              </div>
